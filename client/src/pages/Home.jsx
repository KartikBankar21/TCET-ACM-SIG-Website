...
const Home = () => {
  ...
  const heroImageLink = ["https://res.cloudinary.com/df9us90ur/image/upload/v1727143046/heroimagenight.png","https://res.cloudinary.com/divj3y2cp/image/upload/v1727876473/MorningEveningSIGAI.jpg","https://res.cloudinary.com/df9us90ur/image/upload/v1727143054/heroimageworkinghours.png","https://res.cloudinary.com/df9us90ur/image/upload/v1727779802/IndependenceDayRepublicDayheroimage.png"]
  useEffect(
    ()=>{

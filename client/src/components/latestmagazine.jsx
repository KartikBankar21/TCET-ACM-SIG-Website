...
const Pubs = () => {
  const {
    ...
    loading,
    error,
  } = useFetch("https://tcet-acm-sig-website-yfm4.vercel.app/latestpublication"); // Adjust the URL if needed
  ...
  const viewsUpdater =(magazineid)=>{
    ...
    axios.post("https://tcet-acm-sig-website-yfm4.vercel.app/magazine",id).then((response)=>{
